		...
		try {
			if (isLocal) {
				...
				if ( ctxRemote==null ) {
					...
					//System.out.println("BBVA_WPS_JAVA_NAMING_PROVIDER_URL : "+param1.getValorVariable());
					//System.out.println("BBVA_WPS_JAVA_NAMING_FACTORY_INITIAL : "+param2.getValorVariable());
