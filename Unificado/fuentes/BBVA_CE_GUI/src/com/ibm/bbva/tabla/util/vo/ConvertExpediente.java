...
//		vo.setId(historial.getId());
		...
		vo.getExpedienteTC().setEmpleado(historial.getEmpleado());
		vo.getExpedienteTC().setNroContrato(historial.getNroContrato());
		vo.getExpedienteTC().setOficina(historial.getOficina());
	...
	public static Historial convertToHistorialVO(Expediente vo) {
		...
		System.out.println("vo.getDevolucionTareas(): " + vo.getDevolucionTareas());
		if (vo.getDevolucionTareas()!=null && vo.getDevolucionTareas().size()>0){
				System.out.println("vo.getDevolucionTareas().get(0).getMotivoDevolucion(): " + vo.getDevolucionTareas().get(0).getMotivoDevolucion().getId());
		...
		if(vo.getEmpleado()!=null && vo.getEmpleado().getPerfil()!=null){
			...
			System.out.println("Perfil seteado = "+historial.getPerfil().getDescripcion());
		}
        ...
        if (oficina>0) {                         
            ...
            try { 
                ...
                if (fechaT1!=null && fechaT2!=null) { 
                    ...
                    System.out.println("calculoTiempoCola - Existe Horario : "+(hxo==null || hxo.size()==0?"No":"Si")); 
                    ...
                    System.out.println("calculoTiempoCola - tiempoCola : "+tiempoCola); 
                } 
	...
	public static double calculoTiempoEjecucion(Timestamp fechaT2, Timestamp fechaT3) { 
        ...
        if (fechaT2!=null && fechaT3!=null) { 
                ...
                System.out.println("calculoTiempoEjecucion - minutosEjec : "+minutosEjec); 
        }         
