...
public class RevisarRegistrarDictamenMB extends AbstractMBean {
	...
	private void actualizar (String accion, Integer estado) {
		...
		//fin process
		System.out.println("oficina : "+expediente.getEmpleado().getOficina().getId());
		System.out.println("T1 : "+expediente.getExpedienteTC().getFechaT1());
		System.out.println("T2 : "+expediente.getExpedienteTC().getFechaT2());
		System.out.println("T3 : "+expediente.getExpedienteTC().getFechaT3());
