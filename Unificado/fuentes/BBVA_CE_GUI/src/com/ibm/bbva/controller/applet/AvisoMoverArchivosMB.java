...
import com.ibm.bbva.tabla.controller.ConstantesServidor;
...
public class AvisoMoverArchivosMB extends AbstractMBean {
	...
	public void init() {
		...
		//System.out.println("hostParam : "+hostParam);
		//System.out.println("periodoParam : "+periodoParam);
		//System.out.println("strHostWs : "+strHostWs);
		...
		System.out.println("escaneosPathParam "+escaneosPathParam);
		...
		System.out.println("pathLog "+pathLog);
		//strHostWs = ConstantesServidor.CONSTANTE_HOSTWS;         //ParametersDelegate.getInstance().getValue(Constantes.CONSTANTE_HOSTWS);
		System.out.println("getObjectSession(Constantes.ID_EXPEDIENTE_SESION):" + getObjectSession(Constantes.ID_EXPEDIENTE_SESION));
		prefixParam = String.valueOf(getObjectSession(Constantes.ID_EXPEDIENTE_SESION));
		System.out.println("prefixParam "+prefixParam);
		...
		System.out.println("pathDescargados "+pathDescargados);
		this.listaDocumentosAdjuntos = String.valueOf(getObjectSession(Constantes.LISTA_DOCUMENTOS_ADJUNTOS));
		System.out.println("listaDocumentosAdjuntos "+listaDocumentosAdjuntos);
