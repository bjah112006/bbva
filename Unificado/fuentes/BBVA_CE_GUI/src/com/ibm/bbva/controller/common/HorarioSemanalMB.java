...
public class HorarioSemanalMB extends AbstractMBean {
	...
	private boolean erroresHorarioNormal () {
		...
		/*System.out.println("inicio pantalla::::"+fechaInicio.getTime());
		System.out.println("fin pantalla::::"+fechaFin.getTime());*/
		...
		for (HorarioOficina ho : listaTmp) {
			/*System.out.println("idHorario:::::"+ho.getHorario().getId());
			System.out.println("activo:::::"+ho.getHorario().getActivo());
			System.out.println("excepcion:::::"+ho.getHorario().getExcepcion());
			System.out.println("todoDia:::::"+ho.getHorario().getTodoDia());
			System.out.println("activoPantalla::::"+activo);
			System.out.println("excepcionPantalla::::"+excepcion);*/
			//filtHor.setId(ho.getHorario().getId());
			//filtHor.setActivo(Constantes.CHECK_SELECCIONADO);
			...
			if (ho.getHorario().getActivo().equals(activo ? Constantes.CHECK_SELECCIONADO : Constantes.CHECK_NO_SELECCIONADO) && 
				...
				if(todoDia && ho.getHorario().getTodoDia().equals("1")){
					...
					//System.out.println("inicio Reg:::"+ho.getHorario().getDiaInicio().getTime());
					//System.out.println("fin Reg:::"+diaFinReg.getTime());
			...
			if (!listaHorario.isEmpty()) {
				Horario horario = listaHorario.get(0);
				System.out.println("inicio::::"+horario.getDiaInicio().getTime());
				System.out.println("fin::::"+horario.getDiaFin().getTime());
				if (intervalo.contains(horario.getDiaInicio().getTime())
						|| intervalo.contains(horario.getDiaFin().getTime())) {
					System.out.println("s contiene");
					return true;
				}
			}*/
		}
