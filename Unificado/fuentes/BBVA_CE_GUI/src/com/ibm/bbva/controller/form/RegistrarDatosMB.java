...
//			System.out.println("expediente.getClienteNatural().getTipoCliente().getId() = "+expediente.getClienteNatural().getTipoCliente().getId());
//			System.out.println("tipoCliente.getId() = "+tipoCliente.getId());
			if(getObjectSession(Constantes.FLAG_NACAR_SESION)!=null){
				...
				System.out.println("flagConsultaNacar = "+flagConsultaNacar);
			}
