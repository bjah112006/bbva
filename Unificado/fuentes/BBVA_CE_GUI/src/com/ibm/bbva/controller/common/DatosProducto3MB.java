...
public class DatosProducto3MB extends AbstractMBean {
	...
	private void validarVisualizacionDatos(Expediente expediente) {
		...
		if (expediente.getExpedienteTC().getPlazoSolicitadoApr().trim().equals("")) {
			renderedPlazoSolicAprob = false;
		} else {
			renderedPlazoSolicAprob = true;
		}
	}
	...
	private boolean validarCambiarSituacionExp() {
		...
		System.out.println("tasaEspecial = "+selectedItemTe);
