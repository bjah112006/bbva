...
public class VerificarResultadoDomiciliariaMB extends AbstractMBean {
	...
	public String ventanaRechazar() {
		...
		if (validarDatos()) {
			...
			if(verificacionAprobadoDomiciliaria.getSelectedItemsResultVl3().equals(Constantes.RESULTADO_TIPO_VERIFICACION_OBSERVADO_ID) ||
				...
				System.out.println("ventanaRechazar::VERIFICACION_DOMICILIARIA: "+getObjectSession(Constantes.VERIFICACION_DOMICILIARIA));
				System.out.println("ventanaRechazar::VERIFICACION_LABORAL: "+getObjectSession(Constantes.VERIFICACION_LABORAL));
	...
	public String grabarExp(String accion, Integer estado) {
		...
		if (!Constantes.ACCION_BOTON_EN_ESPERA.equals(accion)) {
			...
			LOG.info("IdPerfil Actual es "+expedienteTCWPS.getIdPerfilUsuarioActual());
		...
		System.out.println("Usuario es codigo = "+empleado.getCodigo());
		System.out.println("setConsiderarUsuarios es = "+consulta.isConsiderarUsuarios());
