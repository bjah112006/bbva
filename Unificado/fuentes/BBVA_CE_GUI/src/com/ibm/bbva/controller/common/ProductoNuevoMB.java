...
public class ProductoNuevoMB extends AbstractMBean {
    ...
    public void init() {	
		...
		if(codTipoOferta!=null && !codTipoOferta.equals(Constantes.CODIGO_CODIGO_CAMPO_VACIO)){
			System.out.println("codTipoOferta="+codTipoOferta);
		}else{
...
//			}
	...
	public boolean esValido () {		
		...
		System.out.println("envio tarjeta = "+isRenderedEnvioTarjeta());
		...
		System.out.println("garantia = "+isRenderedGarantia());
		...
		System.out.println("Plazo solicitado = "+isRenderedPlazoSolicitado());
		String plazoSol = expediente.getExpedienteTC().getPlazoSolicitado();
		...
		System.out.println("RenderedSolicitudTasaEsp = "+isRenderedSolicitudTasaEsp());
		System.out.println("tasaEspecial = "+tasaEspecial);
	...
	public void copiarDatosExpediente () {
		...
		System.out.println("codSubproducto -> "+this.getCodSubproducto());
		if (esValidoSelect (this.getCodSubproducto())) {	
			if(expediente.getExpedienteTC()!=null){
				System.out.println("getExpedienteTC no null ");
			}else
				System.out.println("getExpedienteTC null ");
