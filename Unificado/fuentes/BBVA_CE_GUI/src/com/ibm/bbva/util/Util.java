...
try {
	        ...
	        System.out.println("linea 5 ref:" + ref);
					...
					if(m.containsKey(f.getName())){
						...
						if(rel != null || rel2 != null){
							...
							if(veri == null){
								...
								//System.out.println("Iniciando : "+f.getName() + " de la clase : "+o.getClass().getSimpleName()+" con valor: "+obj2);
