 ...
 */
@Embeddable
public class CarterizacionCEPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CarterizacionCEPK)) {
			return false;
		}
		CarterizacionCEPK castOther = (CarterizacionCEPK)other;
		return 
