...
public class Facade implements FacadeLocal {
	...
	public Documento Content_find(Documento documento) {
		System.out.println("Content_find");
	...
	public Documento obtenerDocumentoCM(DocumentoExpTc documentoExp) {
		...
		System.out.println("obtenerDocumentoCM(Id,Tipo): {"+documentoCM.getId()+","+documentoExp.getTipoDocumento().getCodigo()+"}");
		
		documentoCM2 = Content_find(documentoCM);
		System.out.println("obtenerDocumentoCM " + documentoCM2.getUrlContent());
	...
	public List<Documento> obtenerListaDocumentoCM(DocumentoExpTc documentoExp) {
		...
		System.out.println("numero doi Exp ="+documentoExp.getExpediente().getClienteNatural().getNumDoi());
		documentoCM.setOrigen("PTC");
		
		listaDocumentoCM = Content_findAll(documentoCM);
		System.out.println("obtenerDocumentoCM " + listaDocumentoCM.size());
	...
	public String eliminarDocumentoCM(DocumentoExpTc documentoExp) {
		...
		documentoCM.setOrigen("PTC"); // PTC
		documentoCM.setTipo(documentoExp.getTipoDocumento().getCodigo());
		System.out.println("eliminarDocumentoCM(Id,Tipo): {"+documentoCM.getId()+","+documentoExp.getTipoDocumento().getCodigo()+"}");
