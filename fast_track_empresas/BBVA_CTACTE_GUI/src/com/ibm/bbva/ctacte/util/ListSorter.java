...
public class ListSorter {
	...
	public static void ordenarEstado(List<TareaBandejaVO> lista, final String sortParametro) {

		Collections.sort(lista, new Comparator<TareaBandejaVO>() {

			public int compare(TareaBandejaVO e1, TareaBandejaVO e2) {
				if (e1.getDscEstadoTarea().equalsIgnoreCase(sortParametro)){
					return -1;
				}else if (e2.getOperacion().equalsIgnoreCase(sortParametro)){
					return 1;				
				}
				return 0;
			}
