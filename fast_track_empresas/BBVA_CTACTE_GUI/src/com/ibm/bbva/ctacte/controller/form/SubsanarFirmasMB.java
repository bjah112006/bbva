...
@ManagedBean(name="subsanarFirmas")
@ViewScoped
public class SubsanarFirmasMB extends AbstractMBean
	...
	private static final Logger LOG = LoggerFactory.getLogger(SubsanarFirmasMB.class);
	...
	private FinaliceSolicitud1MB finaliceSolicitud;
	...
	public SubsanarIdentifiquePJOperacionMB getSubsanarIdentifiqueOperacion() {
		return subsanarIdentifiquePJOperacion;
	}
	public void setSubsanarIdentifiqueOperacion(
			SubsanarIdentifiquePJOperacionMB subsanarIdentifiqueOperacion) {
		this.subsanarIdentifiquePJOperacion = subsanarIdentifiqueOperacion;
	}
	...
	public FinaliceSolicitud1MB getFinaliceSolicitud() {
		return finaliceSolicitud;
	}
	public void setFinaliceSolicitud(FinaliceSolicitud1MB finaliceSolicitud) {
		this.finaliceSolicitud = finaliceSolicitud;
	}
	...
	public void setFinaliceSolicitud1(FinaliceSolicitud1MB finaliceSolicitud1) {
		this.finaliceSolicitud=finaliceSolicitud1;
	...
	public void actualizarSubidaDocumentos(Character flagDocumentos) {
		...
		if (finaliceSolicitud!=null) {
			if (faltaDocumentos) {
				finaliceSolicitud.setDisRegEnvExp(true);
			} else {
				finaliceSolicitud.setDisRegEnvExp(false);
			}
		}		
	}
	...
	public boolean hayIndicaciones() {
		return finaliceSolicitud.hayIndicaciones();
	}
	
	public void habilitarBoton(boolean habReasignar) {
		finaliceSolicitud.setBlnReasignar(habReasignar);
	}
	@Override
	public void grabarReenviarExpediente(String accion) {
		...
		expediente.setObservaciones(finaliceSolicitud.getIndicAdicionales());
