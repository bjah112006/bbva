...
public class SimpleLogger {
	...
	public void info (String mensaje) {
		if (desarrollo) {
			simpleLog.println(messageFormat.format(createData("INFO", mensaje)));
		}
		//+POR SOLICITUD BBVA+//+POR SOLICITUD BBVA+System.out..println("INFO  "+mensaje);
	}

	public void info (String mensaje, Throwable th) {
		if (desarrollo) {
			simpleLog.println(messageFormat.format(createData("INFO", mensaje)), th);
		}
		//+POR SOLICITUD BBVA+//+POR SOLICITUD BBVA+System.out..println("INFO  "+mensaje);
	...
	public void error (String mensaje) {
		...
		//+POR SOLICITUD BBVA+//+POR SOLICITUD BBVA+System.out..println("ERROR  "+mensaje);
	}
	
	public void error (String mensaje, Throwable th) {
		simpleLog.println(messageFormat.format(createData("ERROR", mensaje)), th);
		//+POR SOLICITUD BBVA+//+POR SOLICITUD BBVA+System.out..println("ERROR  "+mensaje);
		th.printStackTrace(System.out);
	}
