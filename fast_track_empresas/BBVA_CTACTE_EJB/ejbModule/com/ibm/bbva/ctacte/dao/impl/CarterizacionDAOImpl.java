...
public class CarterizacionDAOImpl extends GenericDAO<Carterizacion, CarterizacionId> implements CarterizacionDAO{
	...
	*/
	...
	public List<Carterizacion> findByWorkerId(Integer id) {
		List<Carterizacion> carteras = new ArrayList<Carterizacion>();

		Query query = em
				.createQuery("select o from Carterizacion o where o.empleado.id = :idEmpleado");

		query.setParameter("idEmpleado", id);

		carteras = query.getResultList();
