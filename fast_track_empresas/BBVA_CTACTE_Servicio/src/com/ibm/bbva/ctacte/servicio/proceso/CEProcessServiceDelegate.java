...
@WebService (targetNamespace="http://proceso.servicio.ctacte.bbva.ibm.com/", serviceName="CEProcessServiceService", portName="CEProcessServicePort")
public class CEProcessServiceDelegate{
    ...
    public boolean enviarCorreo (@WebParam(name="idExpediente") String idExpediente, @WebParam(name="idTareaAnterior") String idTareaAnterior, @WebParam(name="idTareaActual") String idTareaActual, @WebParam(name="codUsuarioAnterior") String codUsuarioAnterior, @WebParam(name="codUsuarioActual") String codUsuarioActual, @WebParam(name="nombreAccion") String nombreAccion) {
        return _cEProcessService.enviarCorreo(idExpediente,idTareaAnterior,idTareaActual,codUsuarioAnterior,codUsuarioActual,nombreAccion);
    }
