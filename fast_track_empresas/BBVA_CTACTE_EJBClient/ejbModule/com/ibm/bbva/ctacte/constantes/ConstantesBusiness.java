...
public interface ConstantesBusiness {
	...
	String ACCION_REINTENTAR_COBRO = "REINTENTAR_COBRO";
	...
	String ESTADO_CARGA_INICIADO = "1";
	String ESTADO_CARGA_EMPLEADOS_TEMPORALES = "2";
	String ESTADO_CARGA_EMPLEADOS_ACTUALIZADOS = "3";
	String ESTADO_CARGA_EPEDIENTES_REASIGNADOS = "4";
	String ESTADO_CARGA_FINALIZADO_ERROR = "5";
	String ESTADO_CARGA_FINALIZADO = "6";
	//[Begin] - [15-10-2015] - [Consulta y Reclamo]
	
	Long ID_PADRE_CATEGORIA_RECLAMO=120L;
	Long CODIGO_HIJO_CATEGORIA_RECLAMO_OPERATIVO=10002L;
	Long CODIGO_HIJO_CATEGORIA_RECLAMO_JURIDICO=10003L;
	
	Long ID_PADRE_TIPO_OPERACION=123L;
	Long CODIGO_HIJO_TIPO_OPERACION_RECLAMO=10005L;
	Long CODIGO_HIJO_TIPO_OPERACION_CONSULTA=10006L;
	
	Long ID_PADRE_ESTADOS_REQUERIMIENTO=126L;	
	Long CODIGO_HIJO_ESTADO_ENVIADO=10008L;
	Long CODIGO_HIJO_ESTADO_CERRADO=10009L;
	Long CODIGO_HIJO_ESTADO_DICTAMINADO=10010L;
	Long CODIGO_HIJO_ESTADO_RECONSIDERADO=10011L;
	
	
	String LABEL_HIJO_ESTADO_ENVIADO="ENVIADO";
	String LABEL_HIJO_ESTADO_CERRADO="CERRADO";
	String LABEL_HIJO_ESTADO_DICTAMINADO="DICTAMINADO";
	String LABEL_HIJO_ESTADO_RECONSIDERADO="RECONSIDERADO";
	
	Long ID_PADRE_ESTADO_DICTAMINADO=129L;
	Long CODIGO_HIJO_DICTAMEN_PROCEDENTE=10012L;
	Long CODIGO_HIJO_DICTAMEN_IMPROCEDENTE=10013L;
	
	String TIPO_ARCHIVO="OTRO1";
	String ORIGEN_ARCHIVO="RCL";
	
	String MENSAJE_CORREO ="mensajeCorreo";
	
	// [End] - [15-10-2015] - [Consulta y Reclamo]
}
