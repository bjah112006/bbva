...
public class EJBLocator {
	...
	public static DatosCorreoDAO getDatosCorreoDAO() {
		return (DatosCorreoDAO) lookupEJBLocal(DatosCorreoDAO.class);
	}
	
	public static EmpleadoLdapDAO getEmpleadoLdapDAO() {
		return (EmpleadoLdapDAO) lookupEJBLocal(EmpleadoLdapDAO.class);
	}
	
	public static ProductoCEDAO getProductoCEDAO() {
		return (ProductoCEDAO) lookupEJBLocal(ProductoCEDAO.class);
	}
	
	public static ProcesoDAO getProcesoDAO() {
		return (ProcesoDAO) lookupEJBLocal(ProcesoDAO.class);
	}
	
	public static HorarioCCDAO getHorarioCCDAO() {
		return (HorarioCCDAO) lookupEJBLocal(HorarioCCDAO.class);
	}
	
	public static RangoCCDAO getRangoCCDAO() {
		return (RangoCCDAO) lookupEJBLocal(RangoCCDAO.class);
	}
