 ...
 */
@Entity
@Table(name = "TBL_CE_IBM_ESTADO_TAREA_CC", schema = "CONELE")
public class EstadoTarea implements java.io.Serializable {

	private static final long serialVersionUID = 2746017746969593212L;

	@Id
	@SequenceGenerator(name = "seqEstado", sequenceName = "SEQ_CE_IBM_ESTADO_TAREA_CC", allocationSize=1, schema = "CONELE")
