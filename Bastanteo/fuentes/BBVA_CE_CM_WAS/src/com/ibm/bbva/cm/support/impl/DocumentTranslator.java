...
public class DocumentTranslator implements DomainTranslator {
	...
	private static final String ATTRIBUTE_ID = "CE_Id";
	private static final String ATTRIBUTE_TYPE = "CE_Type";
	private static final String ATTRIBUTE_MANDATORY = "CE_Mandatory";
	private static final String ATTRIBUTE_EXPIRATION_DATE = "CE_ExpirationDate";
