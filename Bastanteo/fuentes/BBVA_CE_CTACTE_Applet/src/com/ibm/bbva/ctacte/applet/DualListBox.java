...
public class DualListBox extends JPanel {
  ...
  private SortedListModel3 sourceListModel;
  private JList destList;
  private SortedListModel3 destListModel;
  ...
  private void fillListModel(SortedListModel3 model, ListModel newValues) {
  ...
  private void fillListModel(SortedListModel3 model, Object newValues[]) {
  ...
  private void initScreen() {
    ...
    sourceListModel = new SortedListModel3();
    ...
    destListModel = new SortedListModel3();
...
class SortedListModel3 extends AbstractListModel {

  SortedSet model;

  public SortedListModel3() {
    model = new TreeSet();
  }
