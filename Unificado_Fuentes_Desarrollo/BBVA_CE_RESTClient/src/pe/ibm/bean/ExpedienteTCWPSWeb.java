...
public class ExpedienteTCWPSWeb implements Serializable {
	...
	private String valorAnsAmarillo;
	private String valorAnsVerde;
	private String idOficinaUsu;
	...
	public String getValorAnsAmarillo() {
		return valorAnsAmarillo;
	}

	public void setValorAnsAmarillo(String valorAnsAmarillo) {
		this.valorAnsAmarillo = valorAnsAmarillo;
	}

	public String getValorAnsVerde() {
		return valorAnsVerde;
	}

	public void setValorAnsVerde(String valorAnsVerde) {
		this.valorAnsVerde = valorAnsVerde;
	}

	public String getIdOficinaUsu() {
		return idOficinaUsu;
	}
