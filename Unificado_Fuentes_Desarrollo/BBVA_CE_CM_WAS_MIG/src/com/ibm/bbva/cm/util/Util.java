...
//		}
		...
		System.out.println("translateToDocPid doc");
		System.out.println(doc );
		docPid.setId(doc.getId());
		docPid.setTipo(doc.getTipo());
		docPid.setFechaExpiracion(doc.getFechaExpiracion());
		docPid.setMandatorio(doc.getMandatorio());
//		docPid.setContenido(doc.getContenido());
		docPid.setUrlContent(doc.getUrlContent());
...
//		}
		...
		System.out.println("translateToDoc docPid");
		System.out.println(docPid);
		doc.setId(docPid.getId());
		doc.setTipo(docPid.getTipo());
		doc.setFechaExpiracion(docPid.getFechaExpiracion());
		doc.setMandatorio(docPid.getMandatorio());
//		doc.setContenido(docPid.getContenido());
		doc.setUrlContent(docPid.getUrlContent());
