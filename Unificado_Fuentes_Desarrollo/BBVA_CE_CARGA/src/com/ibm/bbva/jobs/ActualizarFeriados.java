...
public class ActualizarFeriados implements Job {
	...
	private static final Logger LOG = LoggerFactory.getLogger(ActualizarFeriados.class);
	...
	public void cargarVariables(){		
		try {
			...
			//LOG.debug("horaEjecucion:"+horaEjecucion);
			flagCargaActivo =  parametrosConfBean.buscarPorVariable(Constantes.ID_APLICATIVO_TC, ConstantesParametros.FERIADOS_FLAG_CARGA_ACTIVO).getValorVariable();
...
//		    LOG.debug(" Scheduler obtenido ...");
	...
	public void logic(){
		...
		// Por si caso verifico el flag de nuevo para que no se ejecute el job si fue deshabilitado
		String activo =  parametrosConfBean.buscarPorVariable(Constantes.ID_APLICATIVO_TC, ConstantesParametros.FERIADOS_FLAG_CARGA_ACTIVO).getValorVariable();
		if (activo != null && activo.equals("1")) {
