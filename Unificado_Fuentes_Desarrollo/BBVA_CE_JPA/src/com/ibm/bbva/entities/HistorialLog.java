...
/**
 * The persistent class for the TBL_CE_IBM_HISTORIAL_LOG database table.
 * 
 */
@Entity
@Table(name="TBL_CE_IBM_HISTORIAL_LOG", schema = "CONELE")
@NamedQueries({
	@NamedQuery(name="HistorialLog.findbyIdExpediente", query="SELECT h FROM HistorialLog h WHERE h.expediente.id = :idExpediente ORDER BY h.id DESC")
})
public class HistorialLog implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="TBL_CE_IBM_HISTORIAL_LOG_ID_GENERATOR", sequenceName="SEQ_CE_IBM_HISTORIAL_LOG", allocationSize=1, schema = "CONELE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="TBL_CE_IBM_HISTORIAL_LOG_ID_GENERATOR")
	private long id;
	...
	@Column(name="MOTIVO_DEVOLUCION_CANCELACION")
	private String motivoDevolucionCancelacion;
	...
	public TareaAd getTareaAd() {
		return this.tareaAd;
	}

	public void setTareaAd(TareaAd tareaAd) {
		this.tareaAd = tareaAd;
	}
	...
	public String getMotivoDevolucionCancelacion() {
		return motivoDevolucionCancelacion;
	}

	public void setMotivoDevolucionCancelacion(String motivoDevolucionCancelacion) {
		this.motivoDevolucionCancelacion = motivoDevolucionCancelacion;
	}	
