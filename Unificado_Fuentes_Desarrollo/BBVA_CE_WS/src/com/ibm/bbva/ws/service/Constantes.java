...
public interface Constantes {
	...
	/**
	 * FIX2 ERIKA ABREGU
	 * Id de Tipo de Scoring en la tabla TBL_CE_IBM_TIPO_SCORING
	 */
	int CODIGO_TIPO_SCORING_APROBADO=1;
	int CODIGO_TIPO_SCORING_RECHAZADO=2;
	int CODIGO_TIPO_SCORING_DUDA=3;
	long CODIGO_GRUPO_SEGMENTO_VIP=1;
	
	/**
	 * FIX2 ERIKA ABREGU
	 * Id de Clasificacion Banco en la tabla TBL_CE_IBM_DELEG_RIESG_CLASBCO
	 */
	long CODIGO_CLASIF_BANCO_NORMAL_TC=6;
	long CODIGO_CLASIF_BANCO_NORMAL_PLD=1;
	long CODIGO_CLASIF_BANCO_CPP_TC=7;
	long CODIGO_CLASIF_BANCO_CPP_PLD=2;
	long CODIGO_CLASIF_BANCO_DEFIC_TC=9;
	long CODIGO_CLASIF_BANCO_DEFIC_PLD=3;
	long CODIGO_CLASIF_BANCO_DUDOSO_TC=8;
	long CODIGO_CLASIF_BANCO_DUDOSO_PLD=4;
	long CODIGO_CLASIF_BANCO_PERDIDA_TC=10;
	long CODIGO_CLASIF_BANCO_PERDIDA_PLD=5;
