...
public class TablaBandejaMonitoreoMB extends AbstractSortPagDataTableMBean {
	...
	private Expediente obtenerExpediente(String codigo) {
		 ...
		 * */
//		LOG.info("Consulta CM (codigo exp="+codigo+")");
//		LOG.info("expediente is null="+(expediente==null));
...
//		
//		if (expediente != null) {
//			// solo debe traer los documentos del cliente
...
//			}
//		else
//			LOG.error("listaDocumentosCM es nulo");
//		
