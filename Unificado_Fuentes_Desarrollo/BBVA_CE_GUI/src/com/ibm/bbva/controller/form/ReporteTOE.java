...
public class ReporteTOE {
	...
	private static final Logger LOG = LoggerFactory.getLogger(ReporteTOE.class);
	...
	public String buscar(){
		...
		if(arrayList!=null){
			...
			LOG.info("parm 2"+ arrayList.get(2));
			LOG.info("parm 3"+ arrayList.get(3));
			LOG.info("parm 4"+ arrayList.get(4));
			LOG.info("parm 5"+ arrayList.get(5));
			LOG.info("parm 6"+ arrayList.get(6));
			LOG.info("parm 7"+ arrayList.get(7));
	...
	public String obtTituloEncabezado(String tipoTit){
		...
		if(arrayList!=null && arrayList.size()>0){
			LOG.info("arrayList 4 = "+this.arrayList.get(4).toString());
