...
@ManagedBean(name = "corregirExp33")
@RequestScoped
public class CorregirExpediente33MB extends AbstractMBean {
	...
	private static final Logger LOG = LoggerFactory.getLogger(CorregirExpediente33MB.class);
	
	public CorregirExpediente33MB() {
...
//							}
	...
	/*public String accionVentana(List<DevolucionTarea> lista) {
		...
		grabarExp(Constantes.ACCION_BOTON_DEVOLVER,
				Constantes.ESTADO_POR_VALIDAR_MESA_CONTROL_TAREA_33);
	...
	public String grabarExp(String accion, Integer estado) {
		...
		/*if (Constantes.ESTADO_POR_VALIDAR_MESA_CONTROL_TAREA_33==estado) {
