...
public interface Constantes {
	...
	/**
	 * Objeto de tipo ExpedeinteVO. Es el expediente hist�rico guardado en bd
	 */
	String EXPEDIENTE_SESION_HISTORICO = "expSesionHistorico";
	
	/**
	 * FIX ERIKA ABREGU
	 * Objeto de tipo ExpedeinteVO. Es el expediente antiguo hist�rico guardado en bd
	 */
    ...
    */
	...
	/**
	 * C�digo para el prestamo formalizado de la tarea 1
	 */
	String CODIGO_PRESTAMO_FORMALIZADO_TAREA1 = "2";
	/**
	 * C�digo para el prestamo formalizado de la tarea 10
	 */
	String CODIGO_PRESTAMO_FORMALIZADO_TAREA10 = "2";
	/**
	 * C�digo para el prestamo formalizado de la tarea 15
	 */
	String CODIGO_PRESTAMO_FORMALIZADO_TAREA15 = "2";
	/**
	 * C�digo para el prestamo formalizado de la tarea 16
	 */
	String CODIGO_PRESTAMO_FORMALIZADO_TAREA16 = "2";
	/**
	 * C�digo para el prestamo formalizado de la tarea 20
	 */
	String CODIGO_PRESTAMO_FORMALIZADO_TAREA20 = "2";
	/**
	 * C�digo para el prestamo formalizado de la tarea 21
	 */
	String CODIGO_PRESTAMO_FORMALIZADO_TAREA21 = "2";
	/**
	 * C�digo para el prestamo formalizado de la tarea 23
	 */
	String CODIGO_PRESTAMO_FORMALIZADO_TAREA23 = "2";
	/**
	 * C�digo para el prestamo formalizado de la tarea 25
	 */
	...
	/**
	 * Objeto de tipo ExpedienteTC almacenado en el �mbito de sesi�n.
	 * Elementos seleccionados de la tabla de b�squeda, �por qu� no se
	 *  corrigi� la palabra 'ExpedeinteTC'?
	 */
	...
	*/	
	...
	/**
	 * Nombre de variable de sesi�n utilizada para inicializar ObservacionRechazoMB
	 */
	...
	/**
	 * Nombre de la accion para el boton confirmar correcci�n
	 */
	 ...
	 * �CU12 � Ejecutar evaluaci�n crediticia� 
	...
	String TITULO_REPORTE_TC_HISTORICO = "Reporte Hist�rico"; /*JBTA*/
	...
	/**
	 * Flag de estados para tener en cuenta en la reasignaci�n de expedientes
	 * */
	...
	Long PARAMETRO_JOB_CARGA_HABILITADO = 119L;
	Long PARAMETRO_JOB_CARGA_DESACTIVACION_HABILITADO = 120L;
