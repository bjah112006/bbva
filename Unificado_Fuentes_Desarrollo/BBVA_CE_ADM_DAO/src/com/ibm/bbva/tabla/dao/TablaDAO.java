...
public class TablaDAO extends BaseDAO {
	...
	public List<TablaDTO> read(TablaDTO filter) throws DataAccessException {
		...
		String query = "SELECT id, Nombre, Nombre_Mostrar, tipo, boton_agregar, boton_actualizar, boton_eliminar FROM "+getEntityQName()+(where.length()==0? "" : " WHERE "+where) + " ORDER BY Nombre_Mostrar";
