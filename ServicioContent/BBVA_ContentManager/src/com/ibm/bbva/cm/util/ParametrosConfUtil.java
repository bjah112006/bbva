...
public class ParametrosConfUtil {
	...
	protected ParametrosConfUtil() {
		...
		propiedadesVA = new HashMap<String, String>();
		...
		if (connection != null) {
			...
			try {
				...
				while (rs.next()) {
					propiedades.put(rs.getString("NOMBRE_VARIABLE"), rs.getString("VALOR_VARIABLE"));
					System.err.println("CODIGO_APLICATIVO_WEBCM: " + rs.getString("NOMBRE_VARIABLE") + " --- " + rs.getString("VALOR_VARIABLE"));
				}
				...
				while (rs1.next()) {
					propiedadesVA.put(rs1.getString("NOMBRE_VARIABLE"), rs1.getString("VALOR_VARIABLE"));
					System.err.println("CODIGO_MODULO_CONF: " + rs1.getString("NOMBRE_VARIABLE") + " --- " + rs1.getString("VALOR_VARIABLE"));
				}
				rs1.close();
			} catch (SQLException e) {
				System.err.println("ERROR AL CARGAR PARAMETROS DE CONFIGURACION: BBVAContentManager");
				e.printStackTrace();
			} finally {
